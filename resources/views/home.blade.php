...
<section class="container hero">
    <div class="row align-items-center h-100">
        ...
        <div class="col-12 col-lg-6 h-315px order-first order-lg-last mb-3 mb-lg-0">
            <img class="hero-image float-lg-end" src="{{ url('assets/images/banner1.png')}}" alt="">
        </div>
    </div>
  </section>
    ...
    <div class="container py-80px">
        ...
        <div class="row">
            <div class="col-12 col-lg-4 mb-3">
                ...
                <div>
                <p class="mb-5">
                    I am working on a blogging application in laravel 10, there are 4 user roles
                </p>
                <div class="row">
                    <div class="col me-1 me-lg-2">
                        <a href=""><span class="badge rounded-pill text-bg-light"></span>Eloquent</a>
                    </div>
                    <div class="col-5 col-lg-7">
                        ...
                        <span class="fs-12px ">
                            <a href="#" class="me-1 fw-bold">Adjie</a>
  ...
  <section class="container min-h-372px d-flex flex-column align-items-center justify-content-center">
    ...
    <div class="text-center">
        <a href="" class="btn btn-primary me-2 mb-2 mb-lg-0">Sign up</a>
        <a href="" class="btn btn-secondary me-2 mb-2 mb-lg-0">Join Discussions</a>
    </div>
  </section>
@endsection
